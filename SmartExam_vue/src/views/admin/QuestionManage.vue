  ...
  <div class="question-manage">
    ...
    <el-card class="table-card">
      ...
      <el-table v-else :data="questionList" border>
        ...
        <el-table-column prop="content" label="题目内容" :show-overflow-tooltip="true" />
        ...
        <el-table-column label="操作" width="280">
          <template #default="scope">
            <el-button size="default" type="info" :icon="View" @click="viewQuestion(scope.row)">
              查看
            </el-button>
            <el-button v-if="!isSuperAdmin()" size="default" type="primary" :icon="Edit" @click="editQuestion(scope.row)">
              编辑
            </el-button>
            <el-button size="default" type="danger" :icon="Delete" @click="handleDeleteQuestion(scope.row)">
              删除
            </el-button>
          </template>
        </el-table-column>
